...
# Extra analysis section (fixed mean calculation)
with st.expander("📊 Data Statistics"):
    numeric_df = df.drop(target_col, axis=1).select_dtypes(include=[np.number])
    st.write("**Dataset Numeric Feature Means:**")
